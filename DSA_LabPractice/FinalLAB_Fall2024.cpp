...
int range_sum(BNode<int>* root, int low, int high)
{
    ...
    {
        cout << "Eligible Scores: " << root->data << endl;
        sum+= root->data;
    }
...
//     // list.insertEnd(inorder(tree.getRoot()));
//     // list.displayForward();
...
int main()
{
        ...
        cout<<"Number of Leaf Nodes: "<<leafNode(tree.getRoot())<<endl;
    return 0;
}